...
const Details = ({
  ...
  :mb-0 w-[60%] mx-auto flex flex-col items-start justify-between relativer "
    >
      <div className="w-5 h-5 absolute left-[24px] bg-dark border-dark border-solid border-2 rounded-full">
    ...
    <>
      <div className="my-64">
        ...
        <div className="w-[75%] mx-auto relative">
          ...
          < WorkHistoryIcon sx={{fontSize:45, position:'absolute', left:10 }}/>
